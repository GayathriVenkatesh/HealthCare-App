...
class UpdatePatientComponentReceptionist extends Component {
    constructor(props) {
        super(props)
...
console.log("BPL IS", this.state.BPL)}
    ...
    cancel(){
        console.log("HEY, I knew I'd run into you somewhere")
        this.props.history.push('/view-patients-receptionist');
    }
    ...
    render() {
        return (
          ...
          <div class="container-fluid">
            ...
            //                             <label> RCH ID: </label>
            //                             <input placeholder="rchId" name="rchId" className="form-control" 
            //                                 value={this.state.rchId} onChange={this.changeRCHHandler}/>
            //                         </div>
            //                         <div className = "form-group">
            //                             <label> SAM ID: </label>
            ...
            //                             <label> Referred By: </label>
            //                             <input placeholder="Referred By" name="referred by" className="form-control" 
            //                                 value={this.state.referredBy} onChange={this.changeReferredByHandler}/>
            //                         </div>
            //                         {/* <div className = "form-group">
...
export default UpdatePatientComponentReceptionist
